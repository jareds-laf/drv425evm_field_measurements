...
# Read the CSV file
csv_path = normalize_path(r'G:\My Drive\Other\REUs\Summer 2024\UCD\Scope Data\ALL0005\F0005CH1.CSV')
# csv_path = normalize_path('D:\ALL0005\F0005CH1.CSV')
...
# Populate G1:I1 with customizable values
R_shunt = 100 * ureg.ohm # Editable
G = 4 * ureg.V / ureg.V # Editable
Gfg = 12 * ureg.mA / ureg.mT # Editable
